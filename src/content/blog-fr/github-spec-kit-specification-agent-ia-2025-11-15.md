---
Meta Title: GitHub Spec-Kit: /specify, /plan, /tasks pour votre agent IA
Meta Description: Vos agents IA dévient de votre intention ? Le spec-kit GitHub transforme votre besoin en spec exécutable en 3 commandes. Voici comment ça fonctionne.
Primary Keyword: spec-kit GitHub
Secondary Keywords: /specify /plan /tasks, spécification agent IA, spec-kit CLI, développement IA structuré léger, alternative BMAD
URL Slug: /blog/github-spec-kit-agent-ia
Publication date: 2025-11-15
Word Count: ~1900
---

# GitHub Spec-Kit: trois commandes pour que votre agent IA construise ce que vous voulez vraiment
...
Une CLI. Trois commandes. Et votre intention se transforme en document exécutable pour l'agent IA que vous utilisez déjà. C'est le principe du développement IA structuré par la spécification : moins d'itérations, plus de fiabilité.
...
La différence entre un prompt et une spec, c'est la différence entre "construis-moi quelque chose qui ressemble à ça" et "voici le contrat exact de ce que tu dois livrer".
...
Vous décrivez votre besoin en langage naturel. Ce que vous voulez construire, pour qui, dans quel contexte, avec quelles contraintes. `/specify` engage un dialogue structuré: il pose des questions de clarification, identifie les zones grises, et produit un document de spécification complet.
...
Le plan est aussi ce qui vous permet de piloter. Chaque étape est délimitée, avec un livrable attendu et des critères de validation. Vous ne mesurez plus l'avancement au feeling -- vous le mesurez à ce qui a été livré et ce qui a été validé.
...
Le spec-kit GitHub crée ce contrat. En trente minutes à deux jours selon la complexité du projet, vous produisez un document exécutable que votre agent IA peut suivre fidèlement, que votre équipe peut valider, et que vous pouvez auditer si quelque chose ne correspond pas.
...
## SEO Checklist
- [x] Primary keyword "spec-kit GitHub" dans H1 et 100 premiers mots (ajouté para 2)
- [x] Primary keyword dans 3 H2 sur 5 (Le problème, Les trois commandes, Ce que ça signifie)
- [x] Primary keyword dans la conclusion
- [x] Secondary keywords /specify /plan /tasks dans H3 dédiés
- [x] 5 liens internes (integration-ia, pilotage-performance, management-de-transition, contact, secteurs/saas)
- [x] Meta title 58 chars (dans les limites SERP)
- [x] Meta description 148 chars avec keyword + CTA
- [x] URL Slug raccourci : /blog/github-spec-kit-agent-ia
- [x] ~1,950 mots
- [x] Hiérarchie H1/H2/H3 respectée
- [x] Tableau comparatif spec-kit vs BMAD pour featured snippet
- [x] LSI keywords ajoutés : spécification structurée, cahier des charges IA, workflow IA, spécification agent IA, document exécutable

## Engagement Checklist
- [x] Hook: BMAD connu → spec-kit comme réponse légère (logique de suite)
- [x] Chaque commande détaillée avec ce qu'elle produit concrètement
- [x] Mini-story 1: responsable produit SaaS B2B (module d'export)
- [x] Mini-story 2: chef de projet agence digitale
- [x] CTA contextuel 1: après mini-stories
- [x] Tableau comparatif spec-kit vs BMAD
- [x] CTA fort final: accompagnement + transition DSI
- [x] Paragraphes 2-4 phrases max
- [x] Voix active tout au long
